<template>
  <view class="sticky-bottom-container-padding">
    <view class="item-detail-page-container safearea-bottom">
      <view class="card">
    ...
    <view class="cu-bar foot bottom-container">
      <view class="space-between-center-container full-width">
        <view class="row-center-container">
          <save-item-button class="medium-margin-left-spacer" :item="item" />
          <chat-message-button
