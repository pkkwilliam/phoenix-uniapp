...
export default {
  ...
  methods: {
    onClickSubmit() {
      ...
      const requestBody = {
        businessRegistrationImageUrl:
          this.businessRegistrationImageUrl.mediaUrls[0].url,
        businessRegistrationNumber: this.businessRegistrationNumber,
        name: this.name,
        ownerCountryCode: this.ownerCountryCode,
        ownerIdNumber: this.ownerIdNumber,
        ownerIdImageUrlBack: this.ownerIdImageUrlBack.mediaUrls[0].url,
        ownerIdImageUrlFront: this.ownerIdImageUrlFront.mediaUrls[0].url,
